...
export interface Episode {
  ...
  playId?: number // myTV SUPER episode id, absent where TVB's catalogue skips a number
}
 ...
 * here to survive TVB re-slugging the title. Watching may need a subscription.
 * Undefined when the episode has no `playId`: TVB's catalogue omits a few numbers
 * the wiki lists.
 */
